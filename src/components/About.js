        ...
        <div class="aboutCont">
            ...
            <div className="about">
                ...
                <div className="things2">
                    <span>Hello, I'm John! I'm a fullstack web developer with experience in JavaScript, React, Ruby on Rails, CSS, and Responsive Design. I bring strong skills in research, project management, and complex problems solving in JavaScript, React, and Rails. I aim to help innovative companies attract users and drive growth.</span> 
                        <br/>
                        <br/>
