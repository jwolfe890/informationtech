            ...
            <div className="about">
                ...
                <div className="things2">
                    <span>Hello, I'm John! I'm a fullstack web developer with experience in JavaScript, React, Ruby on Rails, CSS, and Responsive Design. I bring strong skills in research, project management, and complex problems solving that helps innovative companies attract users and drive growth.</span> 
                        <br/>
                        <br/>
                    <span>I work hard to stay on the cutting edge of software development, and have a talent for learning new technologies efficiently and effectively. Check out some of my projects below and don't hesitate to <a class="abt" href="mailto:jwolfe890@gmail.com?">contact me</a> for your next project!</span>
                </div>
            </div>
        </div>
    );
